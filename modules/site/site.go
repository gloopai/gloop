...
func (s *Site) RegisterPayloadCommand(route string, command string, handler func(ctx context.Context, payload *modules.RequestPayload) modules.ResponsePayload) {
